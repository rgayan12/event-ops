...
const corseDrawer = ({ openCourseDrawer, setOpenCourseDrawer }: any) => {
    ...
    return (
        <div id="drawer-right-example" className={`fixed top-0 right-0 z-40 h-screen p-4 overflow-y-auto transition-transform ${isOpen ? 'translate-x-0' : 'translate-x-full'} bg-white w-80 dark:bg-gray-800`} aria-labelledby="drawer-right-label">
